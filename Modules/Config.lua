...
return {
    ...
    AUTO_BUY_MAX_PROBES_PER_FRUIT = 6,
    ...
    TARGET_USERS = {"KChaos97", "CKhaos79", "Tokushu9779", "Hyperiom_Drake"},
    TELEPORT_POINTS = {
    ...
    ThemePresets = {
        ...
        Ocean = {
            Dark      = Color3.fromRGB(8, 24, 40),
            DarkMid   = Color3.fromRGB(20, 42, 68),
            DarkItem  = Color3.fromRGB(28, 58, 88),
            Green     = Color3.fromRGB(102, 176, 255),
            DarkGreen = Color3.fromRGB(58, 108, 155),
            Red       = Color3.fromRGB(180, 90, 255),
            DarkRed   = Color3.fromRGB(120, 46, 155),
            Gray      = Color3.fromRGB(90, 110, 130),
            White     = Color3.new(1, 1, 1),
            LightGray = Color3.fromRGB(180, 190, 205),
        },
        Forest = {
            Dark      = Color3.fromRGB(10, 30, 15),
            DarkMid   = Color3.fromRGB(20, 60, 25),
            DarkItem  = Color3.fromRGB(32, 74, 32),
            Green     = Color3.fromRGB(130, 200, 115),
            DarkGreen = Color3.fromRGB(60, 120, 65),
            Red       = Color3.fromRGB(210, 130, 140),
            DarkRed   = Color3.fromRGB(120, 70, 80),
            Gray      = Color3.fromRGB(90, 100, 90),
            White     = Color3.new(1, 1, 1),
            LightGray = Color3.fromRGB(190, 200, 190),
        },
        Cyber = {
            Dark      = Color3.fromRGB(12, 8, 25),
            DarkMid   = Color3.fromRGB(40, 12, 70),
            DarkItem  = Color3.fromRGB(55, 20, 100),
            Green     = Color3.fromRGB(140, 100, 255),
            DarkGreen = Color3.fromRGB(90, 50, 180),
            Red       = Color3.fromRGB(255, 80, 155),
            DarkRed   = Color3.fromRGB(180, 70, 115),
            Gray      = Color3.fromRGB(90, 70, 100),
            White     = Color3.new(1, 1, 1),
            LightGray = Color3.fromRGB(210, 185, 210),
        },
    },
